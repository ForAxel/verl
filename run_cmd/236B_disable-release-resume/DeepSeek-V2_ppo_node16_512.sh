...
# 直接使用下载的模型参数和mcore参数
HF_MODEL_PATH='/mnt/seed17/001688/zhaoping/LLMs/DeepSeek-V2'
...
python3 -u -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.megatron.override_transformer_config.recompute_modules='["mlp", "mla_up_proj", "layernorm", "moe"]' \
    ...
    > ../../logs/236B/DeepSeek-V2_ppo_node16_1024-512.log 2>&1 

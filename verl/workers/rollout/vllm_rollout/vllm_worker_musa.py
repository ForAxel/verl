...
class MTGPUWorker(Worker):
    ...
    def wake_up(self) -> None:
        ...
        allocator.wake_up()
        #HACK: the cache may become abnormal due to MumemAllocator.
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        # of the model.
        import torch_musa
        #torch.musa.set_device(int(os.environ.get("RANK", 0)))
        print('device_info in vllm_worker_warp_musa determine_num_available_blocks',self.device_config.device,torch_musa.current_device())
